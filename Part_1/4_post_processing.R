...
saveRDS(df_combined, "combined_outputs_raw.RDS")
...
saveRDS(impact_costs_all, "impact_costs_all_ages.RDS")
saveRDS(impact_costs_age_groups, "impact_costs_age_groups.RDS")
